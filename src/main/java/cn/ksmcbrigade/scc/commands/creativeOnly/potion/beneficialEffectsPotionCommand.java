...
public class beneficialEffectsPotionCommand extends CreativeOnlyCommand {
    public beneficialEffectsPotionCommand() {
        super("ben-ep",(MC,player,args)->{
            ...
            for (Field declaredField : MobEffects.class.getDeclaredFields()) {
                if(declaredField.getType().equals(Holder.class)){
                    ...
                    if(effect.value().getCategory().equals(MobEffectCategory.BENEFICIAL)){
