...
public class hardEffectsPotionCommand extends CreativeOnlyCommand {
    public hardEffectsPotionCommand() {
        super("hard-ep",(MC,player,args)->{
            ...
            for (Field declaredField : MobEffects.class.getDeclaredFields()) {
                if(declaredField.getType().equals(Holder.class)){
                    ...
                    if(effect.value().getCategory().equals(MobEffectCategory.HARMFUL)){
