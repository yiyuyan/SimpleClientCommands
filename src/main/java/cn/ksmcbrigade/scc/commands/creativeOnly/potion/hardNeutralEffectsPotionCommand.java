...
public class hardNeutralEffectsPotionCommand extends CreativeOnlyCommand {
    public hardNeutralEffectsPotionCommand() {
        super("hard-neu-ep",(MC,player,args)->{
            ...
            for (Field declaredField : MobEffects.class.getDeclaredFields()) {
                if(declaredField.getType().equals(Holder.class)){
                    ...
                    if(category.equals(MobEffectCategory.NEUTRAL) || category.equals(MobEffectCategory.HARMFUL)){
